    ...
    function calculation() {
        ...
        while (input.length != 1) {
            while (input.lastIndexOf("(") != -1) {
                ...
                for (; leftStart < input.length; leftStart++) {
                    if (input[leftStart] == ")") {
                        rightStop = leftStart;
                        break;
                    }
